...
class Cdn2015scrapper extends ScrapingEngine {
	...
	public static function initialize($container, $language = 'en') {
		self::setJurisdictionShorthand('cdn');

		parent::setElectionEngine(get_class());

		parent::initialize($container, $language);
	}
	...
	public static function scrape($lang = 'en') {
		...
		$ridingPaths = parent::getRidingPaths(self::getJurisdictionShorthand(), $langPathPart);
	...
	protected static function langPathPartLookup($lang = 'en') {
		$langReturn = 'e';
